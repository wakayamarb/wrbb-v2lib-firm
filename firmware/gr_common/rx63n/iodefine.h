/**
 * MOD EK 28/11/13 : Fixed I2C structures: st_riic0 to st_riic.
 */
...
/********************************************************************************/
/*
 *  Modified 10 May 2014 by Nozomu Fujita : Fixed st_mpc, st_mpu, st_port, st_port2, st_port3, st_riic, st_system, st_usb0, enum_gcr.
 *  Modified 25 May 2014 by Nozomu Fujita : 構造体 st_cmt0 の CMCR.BIT を削除したのに伴い構造体 st_cmcr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_cmcr を st_cmt0_cmcr に改名した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_ad の ADCSR.BIT を削除したのに伴い構造体 st_ad_adcsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_can の MB[].ID.BIT を削除したのに伴い構造体 st_can_mb_id を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_can の FIDCR0.BIT を削除したのに伴い構造体 st_can_fidcr0 を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_can の FIDCR1.BIT を削除したのに伴い構造体 st_can_fidcr1 を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_can の MIER.BIT を削除したのに伴い構造体 st_can_mb を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_can の MIER.BIT を削除したのに伴い構造体 st_can_mier を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_ieb の IECMR.BIT を削除したのに伴い構造体 st_ieb_iecmr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_mtu0 の TSR.BIT を削除したのに伴い構造体 st_mtu0_tsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_mtu1 の TSR.BIT を削除したのに伴い構造体 st_mtu1_tsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_mtu2 の TSR.BIT を削除したのに伴い構造体 st_mtu2_tsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_mtu3 の TSR.BIT を削除したのに伴い構造体 st_mtu3_tsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_mtu4 の TSR.BIT を削除したのに伴い構造体 st_mtu4_tsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_rspi の SPSR.BIT を削除したのに伴い構造体 st_rspi_spsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_sci0 の SSR.BIT を削除したのに伴い構造体 st_sci0_ssr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_sci12 の SSR.BIT を削除したのに伴い構造体 st_sci12_ssr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_system の LVD1CR0.BIT を削除したのに伴い構造体 st_system_lvd1cr0 を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_system の LVD2CR0.BIT を削除したのに伴い構造体 st_system_lvd2cr0 を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_tmr0 の TCSR.BIT を削除したのに伴い構造体 st_tmr0_tcsr を新設した
 *  Modified 31 May 2014 by Nozomu Fujita : 構造体 st_tmr1 の TCSR.BIT を削除したのに伴い構造体 st_tmr1_tcsr を新設した
 *  Modified 12 Jul 2014 by Nozomu Fujita : CN_MTU4_TGIV4 を CN_MTU4_TCIV4 に修正
 */
...
#define MSTP_A27    SYSTEM.MSTPCRA.BIT.MSTPA27
#define MSTP_A24    SYSTEM.MSTPCRA.BIT.MSTPA24
...
#define USBC    (*(volatile struct st_usb     *)0xA0400)
